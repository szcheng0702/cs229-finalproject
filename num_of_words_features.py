...
from feature_engineering import word_overlap_features2, word_overlap_features
...
def generate_features(stances, dataset, name):
    ...
    X_overlap2 = gen_or_load_feats(word_overlap_features2, h, b, "features/overlap." + name + ".npy")
